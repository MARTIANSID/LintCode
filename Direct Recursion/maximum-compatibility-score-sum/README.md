<h2>1947. Maximum Compatibility Score Sum</h2><h3>Medium</h3><hr><div><p>There is a survey that consists of <code>n</code> questions where each question's answer is either <code>0</code> (no) or <code>1</code> (yes).</p>
