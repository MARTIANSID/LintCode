...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,3,4,1,2,3,1]
...
It can be shown that we cannot have less than 3 rows in a valid array.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
