...
<pre style="position: relative;"><strong>Input:</strong> n = 6, connections = [[0,1],[1,3],[2,3],[4,0],[4,5]]
...
<pre style="position: relative;"><strong>Input:</strong> n = 5, connections = [[1,0],[1,2],[3,2],[3,4]]
...
<pre style="position: relative;"><strong>Input:</strong> n = 3, connections = [[1,0],[2,0]]
