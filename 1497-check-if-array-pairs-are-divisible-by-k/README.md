...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,3,4,5,10,6,7,8,9], k = 5
...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,3,4,5,6], k = 7
<strong>Output:</strong> true
...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,3,4,5,6], k = 10
