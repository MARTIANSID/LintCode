...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [60,60,60], nums2 = [10,90,10]
...
The score is max(sum(nums1), sum(nums2)) = max(210, 80) = 210.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> nums1 = [20,40,20,70,30], nums2 = [50,20,50,40,20]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [7,11,13], nums2 = [1,1,1]
