...
<pre style="position: relative;"><strong>Input:</strong> directions = "RLRSLL"
...
<pre style="position: relative;"><strong>Input:</strong> directions = "LLRR"
<strong>Output:</strong> 0
<strong>Explanation:</strong>
No cars will collide with each other. Thus, the total number of collisions that will happen on the road is 0.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
