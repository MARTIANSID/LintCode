<h2><a href="https://leetcode.com/problems/video-stitching/">1024. Video Stitching</a></h2><h3>Medium</h3><hr><div><p>You are given a series of video clips from a sporting event that lasted <code>time</code> seconds. These video clips can be overlapping with each other and have varying lengths.</p>
...
<pre style="position: relative;"><strong>Input:</strong> clips = [[0,2],[4,6],[8,10],[1,9],[1,5],[5,9]], time = 10
...
<pre style="position: relative;"><strong>Input:</strong> clips = [[0,1],[1,2]], time = 5
...
<pre style="position: relative;"><strong>Input:</strong> clips = [[0,1],[6,8],[0,2],[5,6],[0,4],[0,3],[6,7],[1,3],[4,7],[1,4],[2,5],[2,6],[3,4],[4,5],[5,7],[6,9]], time = 9
<strong>Output:</strong> 3
