...
<pre style="position: relative;"><strong>Input:</strong> corridor = "SSPPSPS"
...
<pre style="position: relative;"><strong>Input:</strong> corridor = "PPSPSP"
...
<pre style="position: relative;"><strong>Input:</strong> corridor = "S"
